			...
			<div class="row">
				...
				<div class="col-9">
					<div class="row" style="float: right;">
						<button onclick="location.href='matching/personalWriting.jsp'"
							type="button" class="col-1-4 btn btn-primary"
							style="width: 200px; height: 35px;">글쓰기</button>
					</div>
