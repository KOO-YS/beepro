      ...
      <div class="container">
          ...
          <div class="row">
            ...
            <c:if test="${!empty sessionScope.u_id }">
         	   <div class="row" style="float:right; "><button onclick="location.href='matching/personalWriting.jsp'" type="button" class="col-1-4 btn btn-primary" style="width:200px; height:35px;">글쓰기</button></div>
            </c:if>

<!-- ------------- 개인 메칭 글목록 반복되는 부분 ------------- -->

<c:forEach var="personal" items="${personList}" begin="${page.startRow}" end="${page.startRow + 9}"> <!-- 페이징에 이 문장 하나 추가한 후에 마지막에 e:forEach 닫기 : 리스트 부분 전체를 감싸야 함 -->
