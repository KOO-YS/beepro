...
public class Paging {
    ...
    private void makePaging() {
        ...
        setFirstRow((this.pageNo-1)*this.pageSize+1);
        setEndRow(this.pageNo*this.pageSize);
        System.out.println("첫번쨰행 : "+getFirstRow()+" 마지막행 : "+getEndRow());
    }
	...
	public String toString() {
		return "Paging [pageSize=" + pageSize + ", firstPageNo=" + firstPageNo + ", prevPageNo=" + prevPageNo
				...
				+ nextPageNo + ", finalPageNo=" + finalPageNo + ", totalCount=" + totalCount + ", firstRow=" + firstRow
				+ ", endRow=" + endRow + "]";
	}
...
//출처: https://queserasera.tistory.com/14 [기발한 개발노트]