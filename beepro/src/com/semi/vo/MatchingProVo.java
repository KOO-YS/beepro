...
//		}
//		if (this.need_person != null) {
//			sb.append(", need_person : " + this.need_person);
//		}
...
//	}
	...
	@Override
	public String toString() {
		return "MatchingProVo [projectM_seq=" + projectM_seq + ", pm_id=" + pm_id + ", skill=" + skill + ", title="
				+ title + ", content=" + content + ", need_person=" + need_person + ", location=" + location
				+ ", startdate=" + startdate + ", enddate=" + enddate + ", skillArr=" + Arrays.toString(skillArr)
				+ ", modifyYn=" + modifyYn + ", searchCat=" + searchCat + ", searchKeyword=" + searchKeyword
				+ ", startIndex=" + startIndex + ", cnrPerPage=" + cnrPerPage + "]";
	}
